...
var bgp = manager.getBackgroundProcessHome().getBackgroundProcessByID('BGP_33277547')
logger.info(bgp)
...
var mdl = callMethod(bgp, 'getAttachmentsMetadata')
mdl.forEach(function(md) {
	logger.info(md)
	logger.info(callMethod(md, 'getOriginalAttachmentID'))
})
